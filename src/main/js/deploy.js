...
post_deploy_instructions = "After the build is complete:\n" +
                           ...
                           "3.  If you're router is using the default wildcard certificate generated by OpenShift, copy /etc/origin/master/ca.crt to /etc/origin/master/openunison_openid_ca.crt.  If using a 3rd party CA issued certificate, make sure to copy it to /etc/origin/master/openunison_openid_ca.crt on each master. \n" +
